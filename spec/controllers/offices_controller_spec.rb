...
RSpec.describe OfficesController, type: :controller do
  ...
  let(:valid_attributes) do
    { name: 'Veiga Filho', code: 'PC01', address: 'Rua Dr. Veiga Filho, Higienópolis' }
  end
  ...
  describe 'PUT #update' do
    context 'with valid params' do
      let(:new_attributes) do
        { name: 'Higienópolis', code: 'PC01', address: 'Rua Dr. Veiga Filho, Higienópolis' }
      end
      ...
      it 'updates the requested office' do
        ...
        office.reload
        expect(office.name).to eql('Higienópolis')
      end
