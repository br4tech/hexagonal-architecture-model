...
class ContractService
  ...
  PERMITTED_PARAMS = %i(contract_combo_id category starts_at ends_at amount revenues_at due_at forfeit kind rescheduling_allowed parking parking_value car_license_plate)
  ...
  def commit
    if @contract.valid? 
      @contract.save     
      @contract.contract_combo_id = @contract.client.contract_combos.create.id unless params[:contract_combo_id].present? 
      @contract.save    
    else
